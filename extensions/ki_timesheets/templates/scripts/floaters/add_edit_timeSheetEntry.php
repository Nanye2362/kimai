                ...
                <ul>
                    <li>
                        ...
                        <div class="multiFields">
                            <?php
                            echo $this->formSelect('projectID', $this->projectID, array(
                                'size' => '5',
                    ...
                    <li>
                        ...
                        <div class="multiFields">
                            <?php
                            echo $this->formSelect('activityID', $this->activityID, array(
                                'size' => '5',
                    ...
                    <li>
                        ...
                        <li>
                            ...
                            echo $this->formSelect(
                                    isset($this->id) ? 'userID' : 'userID[]', $this->userID, array(
                                'id' => 'userID',
                                'class' => 'formfield',
            ...
            <fieldset id="budget">
                <ul>
                    ...
                    <li>
                        ...
                        <?php
                        echo $this->formSelect('statusID', $this->statusID, array(
                            'id' => 'statusID',
                            'class' => 'formfield',
                    ...
                    <?php
                    echo $this->formSelect('billable', $this->billable_active, array(
                        'id' => 'billable',
                        'class' => 'formfield',
